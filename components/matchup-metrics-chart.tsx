  ...
  return (
    <div className="rounded-[32px] border border-white/10 bg-white/[0.03] p-4 sm:p-6">
      <div className="mb-5">
        ...
        <h3 className="mt-2 text-2xl font-semibold text-white">Where the statistical gap lives</h3>
      </div>
      <div className="h-80 min-w-0">
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={data} layout="vertical" barCategoryGap={16}>
            ...
            <YAxis dataKey="metric" type="category" stroke="#71717a" tickLine={false} axisLine={false} width={96} />
            <Tooltip
              contentStyle={{
