        ...
        {filteredGames.map((game) => {
          ...
          return (
            ...
            >
              ...
              <div className="mt-4 rounded-[26px] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.04),rgba(255,255,255,0.015))] p-4">
                <div className="flex items-center justify-between gap-2 sm:gap-3">
                  <div className="flex min-w-0 flex-1 items-center gap-2 sm:gap-3">
                    <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-3xl border border-white/10 bg-white/[0.06] shadow-[inset_0_1px_0_rgba(255,255,255,0.08)] sm:h-20 sm:w-20">
                      {game.awayTeam.logoUrl ? (
                        <Image src={game.awayTeam.logoUrl} alt={`${game.awayTeam.city} ${game.awayTeam.name} logo`} width={72} height={72} className="h-14 w-14 object-contain sm:h-[68px] sm:w-[68px]" unoptimized />
                      ) : (
                  ...
                  <div className="flex flex-col items-center gap-2 px-1">
                    <div className="rounded-full border border-lime-300/22 bg-lime-300/12 px-2 py-1 text-[10px] uppercase tracking-[0.24em] text-lime-100 sm:px-3 sm:text-[11px]">
                      VS
                    </div>
                  </div>
                  ...
                  <div className="flex min-w-0 flex-1 items-center justify-end gap-2 text-right sm:gap-3">
                    ...
                    <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-3xl border border-white/10 bg-white/[0.06] shadow-[inset_0_1px_0_rgba(255,255,255,0.08)] sm:h-20 sm:w-20">
                      {game.homeTeam.logoUrl ? (
                        <Image src={game.homeTeam.logoUrl} alt={`${game.homeTeam.city} ${game.homeTeam.name} logo`} width={72} height={72} className="h-14 w-14 object-contain sm:h-[68px] sm:w-[68px]" unoptimized />
                      ) : (
              ...
              <div className="mt-4 flex flex-col gap-3 rounded-2xl border border-white/10 bg-white/[0.03] px-3 py-3 sm:flex-row sm:items-center sm:justify-between">
                <div>
